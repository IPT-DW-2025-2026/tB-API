...
namespace tB_Fotografias.Data.Migrations
{
    ...
    [Migration("20260311121923_ConcludeForeignKeys")]
    partial class ConcludeForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("tB_Fotografias.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PhotographyPurchase", b =>
                {
                    b.HasOne("tB_Fotografias.Models.Photography", null)
                        .WithMany()
                        .HasForeignKey("ListofPhotosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("tB_Fotografias.Models.Purchase", null)
                        .WithMany()
            ...
            modelBuilder.Entity("tB_Fotografias.Models.Photography", b =>
                {
                    b.HasOne("tB_Fotografias.Models.Category", "Category")
            ...
            modelBuilder.Entity("tB_Fotografias.Models.Purchase", b =>
                {
                    b.HasOne("tB_Fotografias.Models.MyUser", "Buyer")
